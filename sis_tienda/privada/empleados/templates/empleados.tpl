	...
	<center>
		...
		<td align="center">
			<form name="formElimi{$r.id_empleado}" method="post" action="empleado_eliminar.php">
				<input type="hidden" name="id_empleado" value="{$r.id_empleado}">
				<a href="javascript:document.formElimi{$r.id_empleado}.submit();" title="Eliminar Empleado Sistema" onclick="javascript:return(confirm('Desea realmente Eliminar al Empleado {$r.nombre} {$r.ap} {$r.am}')); location.href='empleado_eliminar.php'">
					Eliminar>>
				</a>
			</form>
		</td>
